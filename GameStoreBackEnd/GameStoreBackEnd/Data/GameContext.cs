...
namespace GameStoreBackEnd.Data
{
    public class GameContext: IdentityDbContext//<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            string img1 = Convert.ToBase64String(buffer1);
            ...
            string img2 = Convert.ToBase64String(buffer2);
            ...
            string img3 = Convert.ToBase64String(buffer3);
            ...
            string img4 = Convert.ToBase64String(buffer4);
            ...
            string img5 = Convert.ToBase64String(buffer5);
            ...
            string img6 = Convert.ToBase64String(buffer6);
            ...
            string img7 = Convert.ToBase64String(buffer7);
